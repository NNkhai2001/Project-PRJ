                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                            <c:if test="${L.unitsinstock > 0}">
                                                <div  class="text-center"><a class="btn btn-outline-dark mt-auto" href="AddToCartController?pid=${L.productid}&unitstock=${L.unitsinstock}&page=${page}">Add to cart</a></div>                                            
                                            </c:if >
                                            <c:if test="${L.unitsinstock == 0}">
                                                <div class="text-center"><a id="Het hang" onclick="myfuntion(this.id)" class="btn btn-outline-dark mt-auto" href="HomeController?page=${page}">Add to cart</a></div>                                            
                                            </c:if>
