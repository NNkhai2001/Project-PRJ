                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Bill Manager</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="AdminController?do=searchstatus" method="post" style="float: right">
                                        Status:<select name="status" onchange="this.form.submit()" >
                                            <option value="-1" ${-1 == id?"selected":""}>----</option>
                                            <option value="1" ${1 == id?"selected":""}>Wait</option>
                                            <option value="2" ${2 == id?"selected":""}>Process</option>
                                            <option value="3" ${3 == id?"selected":""}>Done</option>
                                        </select>
                                    </form>
                                            ...
                                            <c:forEach items="${list}" var="L">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="${L.orderid}" action="AdminController?do=updateStatus" method="post">                           
                                                            <input type="hidden" name="odId" value="${L.orderid}">                            
                                                            <select name="status" onchange="document.getElementById('${L.orderid}').submit()">
                                                    ...
                                                    <td><a href="AdminController?do=details&odId=${L.orderid}">details</a></td>
