                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="AdminController?do=CreateProduct" method="post"> 
                                    <table>
                                        <%
                                            ResultSet rsSuppliers = (ResultSet) request.getAttribute("rsSupplier"),
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="qPerUnit"></td>
                                        </tr>
                                        <tr>
                                            <td>UnitPrice</td>
                                        ...
                                        <tr>
                                            <td>UnitsInStock</td>
                                            <td><input type="number" name="uInStock"></td>
                                        </tr>
                                        <tr>
                                            <td>UnitsOnOrder</td>
                                            <td><input type="number" name="uOnOrder"></td>
                                        </tr>
                                        <tr>
                                            <td>ReorderLevel</td>
                                            <td><input type="number" name="reOLevel"></td>
                                        </tr>
                                        <tr>
                                            <td>Discontinued</td>
                                            <td><input type="number" name="discontinute"></td>
                                        </tr>
                                        <tr>
                                            <td>Picture</td>
